...
<head>
  ...
  <title>Organizador Campeonato</title>
        ...
        <ul class="navbar-nav m-auto">
          ...
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu">
              <li class="dropdown-submenu"><a class="dropdown-item dropdown-toggle" href="<?php echo BASE_URL; ?>time/adicionar">>Adicionar</a>
                <ul class="dropdown-menu">
                  <li><a class="dropdown-item" href="<?php echo BASE_URL; ?>time/editar">Editar</a></li>
                  <li><a class="dropdown-item" href="<?php echo BASE_URL; ?>time/deletar">Deletar</a></li>
                </ul>
              </li>
              <a class="dropdown-item" href="<?php echo BASE_URL; ?>time/editar">Editar</a>
          ...
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu">
              <a class="dropdown-item" href="<?php echo BASE_URL; ?>arbitragem/adicionar">Adicionar</a>
              <a class="dropdown-item" href="<?php echo BASE_URL; ?>arbitragem/editar">Editar</a>
              <a class="dropdown-item" href="<?php echo BASE_URL; ?>arbitragem/deletar">Deletar</a>
            </div>
          </li>
        </ul>
      </div>
