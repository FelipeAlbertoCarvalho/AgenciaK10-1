        ...
        <ul class="navbar-nav m-auto">
          ...
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu">
              <a class="dropdown-item" href="<?php echo BASE_URL; ?>banner/adicionar">Adicionar</a>
              <a class="dropdown-item" href="<?php echo BASE_URL; ?>banner/alterar">Alterar</a>
              <a class="dropdown-item" href="<?php echo BASE_URL; ?>banner/deletar">Deletar</a>
            </div>
          </li>
          <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle" href="#" id="navbarDropdownMenuLink" data-toggle="dropdown">
            ...
            <div class="dropdown-menu">
              <a class="dropdown-item" href="<?php echo BASE_URL; ?>organizacao/adicionar">Adicionar</a>
              <a class="dropdown-item" href="<?php echo BASE_URL; ?>organizacao/alterar">Alterar</a>
              <a class="dropdown-item" href="<?php echo BASE_URL; ?>organizacao/deletar">Deletar</a>
            </div>
          </li>
          <li class="nav-item">
